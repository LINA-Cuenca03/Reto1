...
public class ChangePassword extends javax.swing.JDialog {
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(txtRepeatPassword, javax.swing.GroupLayout.PREFERRED_SIZE, 205, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(240, 240, 240)
    ...
    private void btnSavePasswordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSavePasswordActionPerformed
        ...
        String nuevaConstraseña = txtNewPassword.getText();
        String repetirContraseña = txtRepeatPassword.getText();
        
        if (nuevaConstraseña.equals(repetirContraseña)){
            JOptionPane.showMessageDialog(this, "Cambio Exitoso", "Actualizacion de Datos", JOptionPane.INFORMATION_MESSAGE);
            this.dispose();
        }else{
            JOptionPane.showMessageDialog(this, "Contraseñas no coinciden", "Actualizacion de Datos", JOptionPane.ERROR_MESSAGE);
