...
public class AddUserForm extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        cbDocumentType.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Cedula de cuidadania", "Cedula de extranjeria", "Libreta militar", "Pasaporte", "Otro" }));
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if (name.isEmpty()||apellido.isEmpty()||documento.isEmpty()||correo.isEmpty()){
            ...
            String query= "INSERT INTO `empleados`( `nombreEmp`, `apellidos`, `tipoDocumento`, `numeroDocumento`, `correo`) VALUES ('"+ name+"',"+apellido+"','["+tipoDocumento+"','"+documento+"','"+correo+"')";
